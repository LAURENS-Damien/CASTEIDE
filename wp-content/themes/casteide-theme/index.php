...
================================================== -->
  <body>
        ...
        <nav class="navbar navbar-inverse navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="#"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/logo.png" class="img-responsive" alt="Logo"></a>
            </div>
	...
	<!-- Image en-tête
    ================================================== -->
	<div id="imageEnTete" class="col-md-12">
		<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/images/photoEnTete.jpg" class="img-responsive" alt="Image d'en-tete">
	</div>
	<?php /*
    <!-- Carousel
    ================================================== -->
